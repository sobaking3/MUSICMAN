...
{
    /// <summary>
    /// Логика взаимодействия для EditComposer.xaml
    /// </summary>
    public partial class EditComposer : Window
    {
        private Notifier notifier;

        public EditComposer(Composer composer)
        {
        ...
        private void ComposerInfoAdd()
        {
            if (ElementsToolsClass.AllFieldsFilled(this))
            {
                Composer.ComposerName = NameTb.Text;
                Composer.MusicCount = Convert.ToInt32(TracksCountTb.Text);
                Composer.CreationDate = CreateDateTb.SelectedDate.Value;
